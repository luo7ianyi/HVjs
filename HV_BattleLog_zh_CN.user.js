...
GM_addStyle('#textlog { position:absolute;left:0px;opacity:0}');
...
let words = {
  ...
  'casts?': '<span style=\"background:#7CFC00\" >释放了</span>',
  ...
  // 伤害
  'fire damage': '<span style=\"background:#f97c7c\" >火元素伤害</span>',
  'cold damage': '<span style=\"background:#94c2f5\" >冰元素伤害</span>',
  'void damage': '<span style=\"background:#ffffff\;color:#5c5a5a\" >真实伤害</span>',
  'elec damage': '<span style=\"background:#f4f375\" >雷元素伤害</span>',
  'wind damage': '<span style=\"background:#7ff97c\" >风元素伤害</span>',
  'dark damage': '<span style=\"background:#000000\;color:#ffffff\" >暗元素伤害</span>',
  'holy damage': '<span style=\"background:#ffffff\;color:#000000\" >圣元素伤害</span>',
