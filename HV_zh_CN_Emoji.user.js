...
(function () {
    ...
    var dictsMap = {
        ...
        '#lottery_eqname' : ['equipsName'], //乐透装备名
        '#lottery_eqstat' : ['equipsInfo'], //乐透装备属性
        'div:not([id])>#leftpane' : ['prizes'], //很混乱的左侧栏，此处为乐透左侧栏
        'div:not([id])>#rightpane' : ['prizes'], //也很乱的右侧栏，此处为乐透右侧栏
...
var words = {
    ...
    */
    ...
    alerts: {
        ...
        '/Are you sure you wish to opt out of the grand prize drawing on this lottery\\? This is not reversible\\./' : '是否确认放弃本次乐透的头奖？此操作无法撤销',
        ...
        //直接写在onclick里的
        '/Are you sure you want to reforge this item\\? This will remove all potencies and reset its level to zero\\./' : '是否确认洗所选装备？此操作将会洗掉该装备所有的已解锁潜能并将潜能等级重置为0。',
    ...
    messagebox: {
        ...
        'No energy items available.' : '你没有可用的红牛',
        ...
        'Ability is already slotted' : '能力已装备',
        'No slot available that fits the given ability' : '没有合适的空槽位适合该能力',
        'The slot does not fit the given ability' : '所选能力不能装备在该槽位上',
        'That slot is already unlocked' : '所指定槽位已解锁',
        'No such slot' : '所指定槽位不存在',
        'Insufficient ability points' : '能力点不足',
        'Insufficient mastery points' : '支配点不足',
        'Ability cannot be increased further' : '你已经将该能力升级满了！',
        'No such ability' : '你没有获得该能力',
        'Level requirements not met' : '你还没有到达解锁该能力要求的等级',
        ...
        'Your wisdom' : '你的智慧',
        'has increased by one' : '已+1',
        'Follower peerless granted!' : '雪花女神用P奖励了你！',
        ...
        'Cannot opt out without buying a ticket first' : '你必须至少购买一张乐透才能决定是否参与头奖争夺',
        'Too many tickets - may not have more than 20,000 tickets per drawing' : '购买数量超过上限 - 每期乐透你最多只能拥有2万张',
        'Must buy at least one ticket' : '最低起购数量1张',
        'No golden tickets to spend' : '你没有黄金乐透券可以使用',
        'Already spent a golden lottery ticket' : '你已经使用了一张黄金乐透券',
        'Already opted out' : '已经决定过放弃头奖',
        'This lottery is closed' : '本期乐透售卖已结束',
        ...
        'Cannot reforge level zero items' : '不能洗潜能等级为0的装备',
        'Cannot reforge locked or equipped items' : '不能洗上锁或者正在穿戴的装备',
        ...
        'Insufficient soul fragments.' : '魂片不足',
        'Insufficient amnesia shards.' : '洗衣粉🧼不足',
    ...
    menu: {
        ...
        'You have increased stamina drain due to low riddle accuracy' : '因为你的马图回答正确率太低，你的体力消耗速率被提高了',
        'Great. You receive a 100% EXP Bonus but stamina drains 50% faster.' : '充沛，你将获得+100%经验奖励，但体力消耗速度增加50%。',
        'Normal. You are not receiving any bonuses or penalties.' : '正常，你既不会收到额外的奖励也不会受到惩罚',
        'Exhausted. You do not receive EXP or drops from monsters, and you cannot gain proficiencies.' : '痿了，你将无法从怪物收到任何经验或者掉落，也无法获得熟练度奖励',
        'You Got Mail' : '你有新邮件',
    },
    ...
    characterStatus: {
        ...
        'Defense' : '防御值相关',
        'physical mitigation' : '物理减伤🛡️',
        'magical mitigation' : '魔法减伤🛡️',
        'evade chance' : '闪避率🧚‍♂️',
        'block chance' : '格挡率🛡️',
        'parry chance' : '招架率⚔️',
        'resist chance' : '抵抗率🛡️',
    ...
    ///////////////////////////////////////////////////////技能
    ability: {
        'Major Ability Slot' : '主要能力槽',
        'Supportive Ability Slot' : '辅助能力槽',
        'Protection Augment Ability Slot' : '“守护”扩充能力槽',
        'Drain Augment Ability Slot' : '“枯竭”扩充能力槽',
        'Click or drag an unlocked ability to fill slot.' : '点击或者拖曳一个已解锁能力到此处安装',
        'Unlock Cost:' : '解锁消耗',
        ...
        '/^Spirit Theft$/' : '灵力窃取',
        'Better Haste' : '凌波微步',
        'Better Shadow Veil' : '锦木千束',
        'Better Absorb' : '吞怪蓝技',
        'Stronger Spirit' : '强力灵力盾',
        'Better Heartseeker' : '强力穿心',
        'Better Arcane Focus' : '强力奥术专注',
        'Better Regen' : '强力持续回血',
        'Better Cure' : '强力奶',
        'Better Spark' : '强力遐蝶',
        'Better Protection' : '强力减伤',
        'Flame Spike Shield' : '火刺盾',
        'Frost Spike Shield' : '冰刺盾',
        'Shock Spike Shield' : '闪刺盾',
        'Storm Spike Shield' : '风刺盾',
        'Conflagration' : '火灾',
        'Cryomancy' : '寒灾',
        'Havoc' : '雷暴',
        '/^Tempest$/' : '风灾',
        ...
        'Elementalism' : '自然崇拜者',
        'Archmage' : '大法师',
        'Better Corruption' : '强力放荡',
        'Better Disintegrate' : '强力崩坏',
        'Better Ragnarok' : '强力崩坏3rd',
        '/^Ripened Soul$/' : '成熟的灵魂',
        'Dark Imperil' : '暗陷危',
        'Better Smite' : '强力肘击',
        'Better Banish' : '强力跑路',
        'Better Paradise' : '强力往逝乐土',
        '/^Soul Fire$/' : '好烧的魂',
        'Holy Imperil' : '圣陷危',
    },
    ...
    abilityInfo: {
        ...
        'Sleep, Confuse' : '沉睡,混乱',
        'Fiery Blast, Freeze, Shockblast, Gale' : '锅巴(火),冰冻(冰),刮风(风),打雷(雷)',
        'Inferno, Blizzard, Chained Lightning, Downburst' : '点燃大海(炎),暴雪(沝),闪电鞭(雷雷),下流暴击(䬕)',
        'Flames of Loki, Fimbulvetr, Wrath of Thor, Storms of Njord' : '红温小洛包(焱),离神(淼),Are you OK?(靐),异样的风暴中心(飍)',
        ...
        //DEBUFF技能
        'Increases the duration and damage decrease granted by Weaken' : '增加 阳痿 法术的持续时间和伤害弱化.',
        'Increases Damage Decrease to ' : '伤害弱化提高到 ',
        'Decreases the casttime and cooldown of weaken. Higher levels also increase the number of targets affected per cast' : '缩短“阳痿”的施放时间和冷却时间。高等级也增加每次施放影响的目标数。',
        ...
        'Augment the Drain spell with the ability to inflict Ether Theft on any target afflicted with Soul Fire.' : '此技能扩充“枯竭”咒语的能力，可对任何受好烧的魂(圣特殊效果)折磨的目标强加以太吸窃效果。',
        ...
        //BUFF技能
        'Increases the action speed-up granted by the Haste spell.' : '增加“凌波微步”咒语给予的行动加速。',
        'Increases the evade bonus granted by the Shadow Veil spell.' : '增加“锦木千束”咒语给予的闪避率奖励。',
        ...
        'Decreases cooldown and increases the maximum number of targets hit by the Corruption spell.' : '缩短冷却时间并且增加“放荡”咒语的最大目标命中数。	',
        'Decreases cooldown and increases the maximum number of targets hit by the Disintegrate spell.' : '缩短冷却时间并且增加“崩坏”咒语的最大目标命中数。	',
        'Decreases cooldown and increases the maximum number of targets hit by the Ragnarok spell.' : '缩短冷却时间并且增加“第三次崩坏”咒语的最大目标命中数。	',
        ...
        'Decreases cooldown and increases the maximum number of targets hit by the Smite holy spell.' : '缩短冷却时间并且增加“肘击”神圣咒语的最大目标命中数。	',
        'Decreases cooldown and increases the maximum number of targets hit by the Banishment holy spell.' : '缩短冷却时间并且增加“跑路”神圣咒语的最大目标命中数。	',
        'Decreases cooldown and increases the maximum number of targets hit by the Paradise Lost holy spell.' : '缩短冷却时间并且增加“往逝乐土”神圣咒语的最大目标命中数。	',
        'Augments your divine spells with the Soul Fire proc, which damages the target over time and enables certain follow-up attacks. Higher levels increase the chance of the proc occurring.' : '扩充你的神圣咒语能力，附加好烧的魂状态，给予持续伤害且能对目标使用某些后续攻击。高等级增加状态触发率。',
        'Added effect: Soul Fire' : '附加效果：好烧的魂',
    ...
    skills: {
        ...
        '/^Fiery Blast$/' : '锅巴(火)',
        '/^Inferno$/' : '点燃大海(炎)',
        '/^Flames of Loki$/' : '红温小洛包(焱)',
        '/^Freeze$/' : '冰冻(冰)',
        '/^Blizzard$/' : '暴雪(沝)',
        '/^Fimbulvetr$/' : '离神(淼)',
        '/^Shockblast$/' : '打雷(雷)',
        '/^Chained Lightning$/' : '闪电鞭(雷雷)',
        '/^Wrath of Thor$/' : 'Are you OK?(靐)',
        '/^Gale$/' : '刮风(风)',
        '/^Downburst$/' : '下流暴击(䬕)',
        '/^Storms of Njord$/' : '异样的风暴中心(飍)',
        '/^Smite$/' : '肘击(Ⅰ)',
        '/^Banishment$/' : '跑路(Ⅱ)',
        '/^Paradise Lost$/' : '往逝乐土(Ⅲ)',
        '/^Corruption$/' : '放荡(Ⅰ)',
        '/^Disintegrate$/' : '崩坏(Ⅱ)',
        '/^Ragnarok$/' : '第三次崩坏(Ⅲ)',
    ...
    items: {
        ...
        'Health Elixir' : '终极体力药㊙️',
        'Mana Potion' : '法力药水🥣',
        'Mana Draught' : '法力长效药🥤',
        'Mana Elixir' : '终极法力药㊙️',
        'Spirit Potion' : '灵力药水🥣',
        'Spirit Draught' : '灵力长效药🥤',
        'Spirit Elixir' : '终极灵力药㊙️',
        'Last Elixir' : '终极秘药㊙️',
        'Energy Drink' : '红牛🐮',
        ...
        'Infusion of Storms' : '风暴魔药🌬️',
        'Infusion of Lightning' : '闪电魔药⚡️',
        'Infusion of Frost' : '冰冷魔药❄️',
        ...
        'Golden Lottery Ticket' : '黄金乐透券🧽',
        'Token of Blood' : '鲜血令牌🩸',
        'Chaos Token' : '混沌令牌👾',
        'Soul Fragment' : '灵魂碎片👻',

        'Binding of Slaughter':  '粘合剂 基础物理伤害（垃圾）🔗',
    ...
    artifact: {
        ...
        'Asian Porn Category Button' : '亚洲片类别按钮',
        ...
        'Tenbora\'s Box' : '菠萝盒(等级9)', // 年度榜单或者年度活动奖品
    ...
    itemInfos: {
        ...
        'Restores 10 points of Stamina, up to the maximum of 99. When used in battle, also boosts Overcharge and Spirit by 10% for ten turns.' : '恢复10点体力，但不超过99。如果在战斗中使用，除恢复体力外附带持续10回合增加10%灵力和斗气.',
        'Restores 5 points of Stamina, up to the maximum of 99. When used in battle, also boosts Overcharge and Spirit by 10% for five turns.' : '恢复5点体力，但不超过99。如果在战斗中使用，除恢复体力外附带持续5回合增加10%灵力和斗气.',
        ...
        'Grants the Spark of Life effect.' : '使用产生遐蝶效果。',
        'Grants the Absorb, Shadow Veil and Spark of Life effects with twice the normal duration.' : '同时产生吸收，闪避，以及遐蝶效果,两倍持续时间.',
        ...
        'Use this ticket on a lottery to add 100 tickets and double your effective ticket count. Will not increase effective count past 10% of the total tickets sold.' : '你可以使用这张彩券兑换100张当期乐透，并且让自己持有的乐透数量翻倍（效果在开奖时计算，最多不超过总奖池10%）',
        ...
        //现有文物和奖杯
        'An advanced technological artifact from an ancient and long-lost civilization. Handing these in at the Shrine of Snowflake will grant you a reward.' : 'PA盲盒，把它交给雪花神殿的雪花女神来获得你的奖励',
        ...
        'A voucher for a free soulbound Peerless equipment piece of your choice. Given to you personally by Snowflake for your devout worship and continued offerings.' : '一张可以根据你的选择部位兑换一件魂绑P的凭证。雪花女神认为你10m够约她了，于是她要给你P。（意味深）',
        ...
        'A 1/10th scale figurine of Princess Luna, aka Nightmare Moon. After escaping her 1000 year banishment to the moon, she was grounded for stealing Celestia\'s socks.' : 'NO.9 露娜公主的 1/10 比例缩放公仔。又名梦靥之月。在结束了一千年的跑路后，她从月球回到阿奎斯陲亚偷走了塞拉斯提娅的袜子。 ',
    ...
    equipsName: {
        ...
        //装备品质
        'Flawless Benediction: Legacy':'无瑕之眷·册礼',
        'Flimsy' : '薄弱',
        'Crude' : '劣等',
        'Fair' : '一般',
        'Average ' : '中等 ',
        ...
        'of Swiftness' : '迅捷',
        'of the Vampire' : '吸血鬼',
        'of the Illithid' : '灵吸怪（吸MP）',
        'of the Banshee' : '报丧女妖（吸SP）',
        'of the Nimble' : '⚔️招架',
        'of the Battlecaster' : '🧚‍♂️战法师',
        'of Destruction' : '🧙‍♀️毁灭',
        'of Focus' : '专注',
        'of Surtr' : '🔥苏尔特（火伤）',
        'of Niflheim' : '❄️尼芙菲姆（冰伤）',
        'of Mjolnir' : '⚡️姆乔尔尼尔（雷伤）',
        'of Freyr' : '🌬️弗瑞尔（风伤）',
        'of Heimdall' : '💨海姆达（圣伤）',
        'of Fenrir' : '💩芬里尔（暗伤）',
    ...
    upgrades: {
        ...
        '/Reforging the selected item will cost (\\d+) shards?./' : '洗所选装备需要消耗 $1 个洗衣粉🧼。',
    ...
    settings: {
        ...
        'You can either use the standard bar which uses pips for charges, or a more utilitarian (and skinnable) bar that has numerical bars for everything.' : '你可以使用预设的两端缩进（类似上古卷轴式）血条来表示生命值，圆点来表示Overcharge槽，也可以使用更直观的通常血条来表示生命值和Overcharge槽。',
        'Standard' : '预设',
        'Utilitarian' : '通常',
    ...
    shrine: {
        ...
        'Here you can make an offering to Snowflake, the Goddess of Loot and Harvest.' : '在这里你可以向雪花女神献上杯子和圣遗物。',
        'Snowflake will grant you various boons depending on your offering.' : '雪花女神会根据你献上的祭品给予相应的馈赠，包括她的P。',
        'Select a trophy, artifact or collectible to continue.' : '从左侧列表中选择一件文物、杯子或者收藏品查看具体献祭说明',
        ...
        'Collectibles can be exchanged for a random selection of bindings and materials.' : '（别献这个！你献这个你是大傻逼）献祭一个收藏品可以获得随机种类的 1 个黏合剂和 1-3 个高阶基本素材',
        'Random Reward' : '随机奖励',
    },
    ...
    monsterLabs: {
        ...
        'Increases monster health by' : '提升怪物的生命值',
        'Increases monster parry by' : '强化怪物的招架率',
        'Increases monster resist by' : '强化怪物的抵抗率',
        'Increases monster evade by' : '强化怪物的闪避率',
    ...
    prizes: {
        ...
        'Each ticket costs' : '购买一张乐透将花费',
        'You already spent a Golden Lottery Ticket.' : '你已经使用了一张黄金乐透券',
        'Choose number to buy' : '输入购买数量',
        '/You hold ([\\d,]+) of/' : '你拥有 $1 /',
        'sold tickets' : '张已售出的乐透',
        'Stock:' : '库存：',
        'The Weapon Lottery lets you spend GP on a chance to win the specific equipment piece shown on the left.' : '使用GP购买武器乐透有机会赢取“无双”武器',
        'Each lottery period lasts 24 hours. At midnight UTC, a drawing is held, and a new lottery period starts.' : '每期乐透发行期为24小时，武器乐透于协调世界时 0点（8:00） 开奖，同时发行新一期乐透',
        'In addition to normal tickets, you can also spend a Golden Lottery Ticket to add 100 tickets and double your effective ticket count at the time of drawing. This will not increase the effective ticket count past 10% of the total purchased tickets. Golden Lottery Tickets can only be acquired as a consolation prize from the lottery.' : '你也可以使用黄金乐透券兑换100张乐透，并且让自己持有的乐透数量翻倍（效果在开奖时计算，最高不超过10%总售出乐透）。黄金乐透券只能通过购买乐透中奖获得。',
        'The number of items granted by the 2nd-5th prize will increase with the size of the pot. You can only ever win one of the prizes no matter how many tickets you purchase.' : '2-5等奖的奖品数量取决于彩池的大小，无论你购买了多少注乐透，你只能中一个奖项，如果你不想要一等奖装备，那么你可以点击一等奖下面的DO NOT WANT按钮，这会令你放弃头奖装备，取而代之如果你抽中头奖你将获得对应的装备核心',
        'The Armor Lottery lets you spend GP on a chance to win the specific equipment piece shown on the left.' : '使用GP购买防具乐透有机会获得“无双”防具',
        'Each lottery period lasts 24 hours. At noon UTC, a drawing is held, and a new lottery period starts.' : '每期乐透持续24小时，防具乐透于协调世界时 12点（20:00） 开奖，同时发行新一期乐透',
        'Today\'s ticket sale is closed.' : '本期乐透售卖已结束',
        'Today\'s drawing is in' : '距离今日开奖还剩',
        'hours and' : '小时',
        'hours' : '小时',
        'minutes' : '分钟',
        'Ticket sales will close up to ten' : '乐透售卖将于开奖前 10',
        'before this time.' : '结束',
        '/Chaos Tokens?/' : '混沌令牌',
        '/Caffeinated Cand(y|ies)/' : '咖啡因糖果',
        '/Golden Lottery Tickets?/' : '黄金乐透券',
        'You cannot opt out unless you have at least one ticket.' : '你必须至少购买一张乐透才能选择放弃头奖争夺',
        'You will not participate in the drawing for the grand prize of this lottery.' : '你已经放弃参与本次乐透的头奖争夺',
    },
    ...
    battle: {
        ...
        'To Kill a God' : '弑神之路',
        'Eve of Death' : '死亡前夜',
        'The Trio and the Tree' : '命运三女神与树（树场）',
        'End of Days' : '世界末日',
        'Eternal Darkness' : '永恒黑暗',
        'A Dance with Dragons' : '与龙共舞（龙场）',
        'Post-Game Content' : '赛后内容（记得末轮虚弱）',
        'Secret Pony Level' : '秘密小马等级（记得末轮虚弱）',
        'Konata' : '泉此方',
        ...
        'Flying Spaghetti Monster' : '飞行意大利面怪物（面场）',
        ...
        'Ranking high in this mode at the end of the season will provide you with some permanent bonuses on HV Persistent.' : '在塔楼下爬上50层将在每个赛季结束后获得一些主世界模式的P卷。100层再来一张。',
    ...
    ///////////////////////////////////////////////////////战斗行动
        ...
        'Choose from the Battle Actions highlighted above, and use them to defeat your enemies listed to the right. When all enemies are reduced to zero Health, you win. If your Health reaches zero, you are defeated.' : '选择上面的任意一个行动来打倒右侧的敌人。当所有敌人均被清掉时，你过关！当你的生命为0时，你就会被飞出去。',
    ...
    /////////////////////////////////////////////////////效果、需求说明
        ...
        '/Requires (\\d+) Charges? to use/' : '需要 $1 豆',
        '/Requires (\\d+) Magic Points and (\\d+) Charges? to use/' : '需要 $1 点 MP 和 $2 豆',
    ...
    /////////////////////////////////////////////////////技能、技巧说明
        ...
        'Massive AoE damage to all enemies on the battlefield.' : '一炮轰全场，真伤秒一切。非死即大残，只需小补刀。',
        'Damages and temporarily staggers all enemies on the battlefield.' : '一吼震全场，真伤全打残。还附五回合晕。',
    ...
    /////////////////////////////////////////////////////状态
        ...
        '/^Defending$/' : '防御',
        '/^Fleeing$/' : '逃跑',
        'You are mentally prepared for casting a magical attack. The chance for your spell being evaded or resisted is reduced, but so are your avoidance stats.' : '你正集中体力准备释放法术，你的法术被闪避和被抵抗概率降低，但你自身的躲避能力同样下降。',
        ...
        'A veil of shadows surround the target, increasing its chance to evade attacks and spells by' : '目标被锦木千束包围，闪避率增加',
        ...
        'Being brought back by Spark of Life has draped you with this powerful protective shield, increasing your damage resistance for a brief time.' : '“遐蝶”保护了你，并短暂地强化你的伤害抗性。',
        ...
        'Internal damage causes slower reactions and lowers evade and resist chance. Fire resistance is lowered.' : '体内的伤害导致反应迟钝，降低闪避率与抵抗率，火抗性降低。',
        ...
        'The life essence of the target has been corrupted beyond repair, damaging its physical form over time.' : '此目标的生命之核持续著无法修补的放荡，对它造成持续性物理伤害。',
