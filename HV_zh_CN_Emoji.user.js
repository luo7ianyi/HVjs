...
var words = {
    ...
    */
    ...
    upgrades: {
        ...
        '/Reforging the selected item will cost (\\d+) shards?./' : '重铸所选装备需要消耗 $1 个洗衣粉🧼。',
    ...
    ///////////////////////////////////////////////////////战斗行动
        ...
        'Choose from the Battle Actions highlighted above, and use them to defeat your enemies listed to the right. When all enemies are reduced to zero Health, you win. If your Health reaches zero, you are defeated.' : '选择上面的任意一个行动来打倒右侧的敌人。当所有敌人生命为0时，你获得胜利，当你的生命为0时，你就会被飞出去。',
